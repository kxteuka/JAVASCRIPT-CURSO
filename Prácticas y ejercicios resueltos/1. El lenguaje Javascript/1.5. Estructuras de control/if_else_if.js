...
tiempodecoccion = prompt(
  "¿Cuanto tiempo has cocinado el pollo? (Introduce el valor en horas) "
);
...
if (pollococinado >= 250.0 && tiempodecoccion >= 1.0) {
  ...
  document.write(
    "El pollo aún está frio. Vuelve a intentarlo cuando esté sobre 100.0 grados."
  );
}
