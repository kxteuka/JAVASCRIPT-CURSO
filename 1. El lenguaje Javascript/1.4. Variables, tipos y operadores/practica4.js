...
alert(
  "Recuerda: Si aceptas, se sumará el primero con el segundo. Si cancelas, se restará el primero al segundo."
);
...
if (Respuesta == _123numeros) {
  ...
  document.write(
    "¡Casi! El valor era " + _123numeros + ". <br />Intentalo de nuevo."
  );
}
